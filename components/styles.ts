...
export const sectionTitleBigClasses =
	'text-4xl sm:text-5xl md:text-6xl xl:text-8xl text-slate-900 dark:text-white font-semibold lg:-ml-1 xl:-ml-1';
export const sectionTitleClasses =
	'text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-slate-900 dark:text-white font-bold';
